...
import { Coins, Briefcase, CheckCircle, MessageCircle, TrendingUp, Tag } from 'lucide-react';
        ...
        <div className="max-w-lg mx-auto p-4 space-y-4">
            ...
            <Card className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <h2 className="font-bold text-lg" data-testid="text-dashboard-username">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <DashboardCard
              ...
              title="Rating"
              value="4.9"
              description="35 ulasan"
              iconColor="text-chart-4"
            />
          </div>

          <div>
            <h3 className="font-semibold mb-3" data-testid="text-activity-title">Aktivitas Terbaru</h3>
            {myPosts.length === 0 ? (
              ...
              <div className="space-y-3">
                {myPosts.slice(0, 5).map((post) => (
                  <Card key={post.id} className="p-4 hover-elevate" data-testid={`card-activity-${post.id}`}>
                    <div className="flex gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="font-medium text-sm truncate">{post.description}</p>
